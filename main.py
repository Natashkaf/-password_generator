...
class App(CTk.CTk):
    def __init__(self):
        ...
        self.logo = CTk.CTkImage(dark_image=Image.open("Letter - 1.png"), size=(460, 153))
        ...
        self.bth_generate = CTk.CTkButton(master=self.password_frame, text="Generate", width=100,
                                          command=self.set_password)
        self.bth_generate.grid(row=0, column=1)
        self.setting_frame = CTk.CTkFrame(master=self)
        self.setting_frame.grid(row=2, column=0, padx=(20, 20), pady=(20, 0), sticky="nsew")

        self.password_lenth_slider = CTk.CTkSlider(master=self.setting_frame, from_=0, to=100, number_of_steps=100,
                                                   command=self.slider_event)
        self.password_lenth_slider.grid(row=1, column=0, columnspan=3, pady=(20, 20), sticky="ew")

        self.password_lenth_entry = CTk.CTkEntry(master=self.setting_frame, width=50)
        self.password_lenth_entry.grid(row=1, column=3, padx=(20, 10), sticky="we")
        ...
        self.password_lenth_slider.set(12)
        self.password_lenth_entry.insert(0, 12)
    ...
    def slider_event(self, value):
        self.password_lenth_entry.delete(0, "end")
        self.password_lenth_entry.insert(0, int(value))
    ...
    def set_password(self):
        ...
        self.entry_password.insert(0, password.create_new(lenth=int(self.password_lenth_slider.get()),
